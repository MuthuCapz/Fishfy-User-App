...
class ShopTwoViewModel : ViewModel() {
    ...
    private suspend fun retrievePopularItems() {
        val foodRef: DatabaseReference = database.reference.child("Shop 2").child("menu")
    ...
    private suspend fun retrieveMenu1Items() {
        val menu1Ref: DatabaseReference = database.reference.child("Shop 2").child("menu1")
    ...
    private suspend fun retrieveMenu3Items() {
        val menu3Ref: DatabaseReference = database.reference.child("Shop 2").child("menu2")
    ...
    private suspend fun retrieveDiscountItems() {
        val discountRef: DatabaseReference = database.reference.child("Shop 2").child("discount")
