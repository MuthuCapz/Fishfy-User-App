...
import com.capztone.seafishfy.databinding.FragmentShopFourBinding
...
import com.capztone.seafishfy.ui.activities.ViewModel.ShopFourViewModel
import java.util.*

class ShopFourFragment : Fragment() {

    private lateinit var binding: FragmentShopFourBinding
    private val viewModel: ShopFourViewModel by viewModels()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentShopFourBinding.inflate(inflater, container, false)

        observeViewModel()

        binding.menuItemTextView.setOnClickListener {
            val bottomSheetDialog = MenuBottomSheetFragment3()
