...
import com.capztone.seafishfy.databinding.FragmentShopTwoBinding
...
import com.capztone.seafishfy.ui.activities.ViewModel.ShopTwoViewModel
import java.util.*

class ShopTwoFragment : Fragment() {

    private lateinit var binding: FragmentShopTwoBinding
    private val viewModel: ShopTwoViewModel by viewModels()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentShopTwoBinding.inflate(inflater, container, false)

        observeViewModel()

        binding.menuItemTextView.setOnClickListener {
            val bottomSheetDialog = MenuBottomSheetFragment1()
