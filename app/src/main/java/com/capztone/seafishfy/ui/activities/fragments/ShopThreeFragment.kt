...
import com.capztone.seafishfy.databinding.FragmentShopThreeBinding
...
import com.capztone.seafishfy.ui.activities.ViewModel.ShopThreeViewModel
import java.util.*

class ShopThreeFragment : Fragment() {

    private lateinit var binding: FragmentShopThreeBinding
    private val viewModel: ShopThreeViewModel by viewModels()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentShopThreeBinding.inflate(inflater, container, false)

        observeViewModel()

        binding.menuItemTextView.setOnClickListener {
            val bottomSheetDialog = MenuBottomSheetFragment2()
