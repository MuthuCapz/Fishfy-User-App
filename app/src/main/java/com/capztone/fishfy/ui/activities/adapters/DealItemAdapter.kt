...
import com.capztone.fishfy.databinding.DealsItemBinding
...
class  DealItemAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val cartItem = cartItems.getOrNull(position)
    ...
    inner class ViewHolder(private val binding: DealsItemBinding) :
